...
import {urlInicio, urlCategorias, urlOfertas, urlFavoritos, urlCarrito, urlCarpetaImg, urlBuscador} from "../modules/urls.mjs";
...
export function showMenu() {
    ...
    header.innerHTML = `
        <section class="container" id="menu-top">
        ...
        <section class="mt-3 container" id="menu-bottom">
